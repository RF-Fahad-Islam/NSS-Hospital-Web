-- Seed Branches
insert into branches (id, name, address, phone, email, map_url, image, manager_name, sequence) values
('downtown', 'ডাউনটাউন মেডিকেল সেন্টার', '১২৩ মেইন স্ট্রিট, ডাউনটাউন, সিটি ১০০০১', '+1 (555) 123-4567', 'downtown@medicareplus.com', 'https://maps.google.com', 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800', 'আব্দুর রহিম', 1),
('westside', 'ওয়েস্টসাইড হেলথ ক্যাম্পাস', '৪৫৬ ওক অ্যাভিনিউ, ওয়েস্টসাইড, সিটি ১০০০২', '+1 (555) 234-5678', 'westside@medicareplus.com', 'https://maps.google.com', 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=800', 'করিমুল হাসান', 2),
('eastside', 'ইস্টসাইড কমিউনিটি হাসপাতাল', '৭৮৯ পাইন রোড, ইস্টসাইড, সিটি ১০০০৩', '+1 (555) 345-6789', 'eastside@medicareplus.com', 'https://maps.google.com', 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800', 'নাসরিন আক্তার', 3),
('north', 'নর্থ স্পেশালিটি ক্লিনিক', '৩২১ এলম বুলেভার্ড, নর্থ ডিস্ট্রিক্ট, সিটি ১০০০৪', '+1 (555) 456-7890', 'north@medicareplus.com', 'https://maps.google.com', 'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800', 'শামসুল হক', 4)
...
-- Seed Doctors
insert into doctors (id, name, specialty, experience, rating, image, branch_id, education, bio, languages, available_days, role, sequence) values
('dr-anderson', 'ডাঃ মাইকেল অ্যান্ডারসন', 'হৃদরোগ বিশেষজ্ঞ', '২০+ বছর', 4.9, 'dr-anderson.jpg', 'downtown', 'হার্ভার্ড মেডিকেল স্কুল থেকে এমডি', 'ডাঃ অ্যান্ডারসন জটিল হৃদরোগ চিকিৎসায় দুই দশকেরও বেশি অভিজ্ঞ। তিনি বেশ কিছু ন্যূনতম ইনভেসিভ কার্ডিয়াক পদ্ধতির পথিকৃৎ।', ARRAY['English', 'Spanish'], ARRAY['Monday', 'Wednesday', 'Friday'], 'doctor', 1),
('dr-mitchell', 'ডাঃ সারাহ মিচেল', 'শিশুরোগ বিশেষজ্ঞ', '১২+ বছর', 4.8, 'dr-mitchell.jpg', 'westside', 'স্ট্যানফোর্ড ইউনিভার্সিটি থেকে এমডি', 'ডাঃ মিচেল শিশুদের বিকাশে বিশেষ যত্ন নিয়ে থাকেন। তিনি শিশুদের জন্য একটি আরামদায়ক পরিবেশ তৈরি করতে আগ্রহী।', ARRAY['English', 'French'], ARRAY['Tuesday', 'Thursday', 'Saturday'], 'doctor', 2),
('dr-garcia', 'ডাঃ রবার্ট গার্সিয়া', 'স্নায়ুরোগ বিশেষজ্ঞ', '১৮+ বছর', 4.9, 'dr-garcia.jpg', 'eastside', 'জনস হপকিন্স ইউনিভার্সিটি থেকে এমডি', 'ডাঃ গার্সিয়া স্নায়বিক ব্যাধিতে বিশেষজ্ঞ এবং স্ট্রোক প্রতিরোধ ও চিকিৎসায় বিশেষ দক্ষ। তিনি আমাদের নিউরোলজি গবেষণা বিভাগের নেতৃত্ব দিচ্ছেন।', ARRAY['English', 'Spanish', 'Portuguese'], ARRAY['Monday', 'Tuesday', 'Thursday'], 'doctor', 3),
('dr-thompson', 'ডাঃ এমিলি থম্পসন', 'অর্থোপেডিক সার্জন', '১৫+ বছর', 4.7, 'dr-thompson.jpg', 'north', 'ইয়েল স্কুল অফ মেডিসিন থেকে এমডি', 'ডাঃ থম্পসন স্পোর্টস মেডিসিন এবং জয়েন্ট রিপ্লেসমেন্টে দক্ষ একজন অর্থোপেডিক সার্জন। তিনি অসংখ্য পেশাদার ক্রীড়াবিদদের চিকিৎসা করেছেন।', ARRAY['English'], ARRAY['Wednesday', 'Friday', 'Saturday'], 'doctor', 4),
('dr-chen', 'ডাঃ লিসা চেন', 'চক্ষু বিশেষজ্ঞ', '১৪+ বছর', 4.8, 'dr-chen.jpg', 'downtown', 'কলম্বিয়া ইউনিভার্সিটি থেকে এমডি', 'ডাঃ চেন জটিল চোখের অবস্থার চিকিৎসায় বিশেষজ্ঞ এবং ল্যাসিক ও ছানি অপসারণ সহ ৫,০০০ টিরও বেশি সফল চোখের অস্ত্রোপচার করেছেন।', ARRAY['English', 'Mandarin'], ARRAY['Monday', 'Wednesday', 'Friday'], 'doctor', 5),
('dr-wilson', 'ডাঃ জেমস উইলসন', 'জেনারেল ফিজিশিয়ান', '২২+ বছর', 4.9, 'dr-wilson.jpg', 'westside', 'ইউসিএলএ থেকে এমডি', 'ডাঃ উইলসন রোগীর সুস্থতার জন্য সামগ্রিক দৃষ্টিভঙ্গি নিয়ে ব্যাপক প্রাথমিক যত্ন প্রদান করেন। তিনি প্রতিরোধমূলক ওষুধ ও রোগীর শিক্ষায় বিশ্বাসী।', ARRAY['English', 'German'], ARRAY['Tuesday', 'Thursday', 'Saturday'], 'doctor', 6)
on conflict (id) do nothing;

-- Seed Gallery Items
-- Note: id is serial, so we let Postgres handle it.
